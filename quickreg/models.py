...
class quick(models.Model):
	...
	panel_des = models.CharField(max_length = 500)
	panel_elixir = models.CharField(max_length = 500)
	panel_robo = models.CharField(max_length = 500)
	panel_prog = models.CharField(max_length = 500)
	panel_specials = models.CharField(max_length = 500)
	panel_init = models.CharField(max_length = 500)
